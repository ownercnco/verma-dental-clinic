        ...
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-5">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-lg font-medium">Lumina Dental</span>
            </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 text-primary" /> 240 Cedar Lane, Suite 14<br />Portland, OR 97209</li>
              <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-primary" /> (800) 555-LUMI</li>
              <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary" /> care@luminadental.co</li>
            </ul>
          </div>
